...
public class GeneticOperators {
    ...
    public static void crossover(final Individual parent1, final Individual parent2,
        ...
        List<Integer> ch1 = new ArrayList<>(p1.size());
        List<Integer> ch2 = new ArrayList<>(p1.size());
        int size = p1.size();
        ...
        int currentCity;
        int currentCityParent1;
        int currentCityParent2;
