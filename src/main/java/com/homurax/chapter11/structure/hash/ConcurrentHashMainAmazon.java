package com.homurax.chapter11.structure.hash;

import com.homurax.chapter11.structure.hash.data.ConcurrentLoaderAccumulator;
import com.homurax.chapter11.structure.hash.data.ExtendedProduct;
...
class ConcurrentHashMainAmazon {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // Transformer
            BiFunction<String, List<ExtendedProduct>, List<ExtendedProduct>> transformer
					= (key, value) -> value.stream().filter(product -> product.getValue() == 1).collect(Collectors.toList());
