...
import com.homurax.synchronization.data.Review;
...
public class CompletableMain {
    ...
    public static void main(String[] args) {
        ...
        completableProductResult.completeOnTimeout("TimeOut", 10, TimeUnit.SECONDS);
