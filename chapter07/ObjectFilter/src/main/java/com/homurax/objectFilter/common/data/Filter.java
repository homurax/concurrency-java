package com.homurax.objectFilter.common.data;
...
public class Filter {
    ...
    public static boolean filter(CensusData data, List<FilterData> filters) {
        for (FilterData filter : filters) {
            boolean result = evaluateFilter(data, filter);
            if (!result) {
                return false;
            }
        }
    ...
    private static boolean evaluateFilter(CensusData data, FilterData filter) {
        switch (filter.getIdField()) {
            case 0:
                if (data.getAge() == Integer.parseInt(filter.getValue())) {
                    return true;
                }
                break;
            case 1:
                ...
                break;
            case 2:
                if (data.getIndustryCode() == Integer.parseInt(filter.getValue())) {
                    return true;
                }
                break;
            case 3:
                if (data.getOccupationCode() == Integer.parseInt(filter.getValue())) {
                    return true;
                }
                break;
            case 4:
                ...
                break;
            case 5:
                if (data.getWagePerHour() == Integer.parseInt(filter.getValue())) {
                    return true;
                }
                break;
            case 6:
            ...
            case 15:
                ...
                break;
            case 16:
                if (data.getCapitalGains() == Integer.parseInt(filter.getValue())) {
                    return true;
                }
                break;
            case 17:
                if (data.getCapitalLosses() == Integer.parseInt(filter.getValue())) {
                    return true;
                }
                break;
            case 18:
                if (data.getDividendsFromStocks() == Integer.parseInt(filter.getValue())) {
                    return true;
                }
                break;
            case 19:
            ...
            case 37:
                ...
                break;
            case 38:
                if (data.getWeeksWorkedInYear() == Integer.parseInt(filter.getValue())) {
                    return true;
                }
                break;
            case 39:
